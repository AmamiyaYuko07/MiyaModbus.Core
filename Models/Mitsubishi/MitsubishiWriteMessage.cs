...
{
    public class MitsubishiWriteMessage : BaseMessage
    {
        public MitsubishiWriteMessage(int Addr, int Value)
        {
            this.Addr = Addr;
            this.Value = Value;
        }
        ...
        public override byte[] Build()
        {
            ...
            var data = Asc(Value.ToString("X4"));
            data = data.Substring(data.Length - 6) + data.Substring(0, 6);
            var sendcmd = "02 31 " + addrasc + "30 32 " + data + "03";
